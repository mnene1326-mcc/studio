  ...
  return (
    <div className="flex-1 bg-white min-h-screen flex flex-col">
      <header className="px-4 h-16 flex items-center justify-between border-b">
        ...
        <h1 className="text-base font-bold text-black">Identity Verification</h1>
        <div className="w-10" />
      </header>
        ...
        {profile?.isVerified ? (
          <div className="flex-1 flex flex-col items-center justify-center space-y-10 animate-in zoom-in-95 duration-500">
            ...
            <div className="text-center space-y-3">
              <h2 className="text-2xl font-bold text-black tracking-tight">Profile Verified</h2>
              <p className="text-sm font-medium text-gray-500 px-8 leading-relaxed">
                Your identity has been confirmed. You have the verified badge on your profile.
              </p>
            </div>
            <Button 
              className="w-full h-16 rounded-full bg-[#00A2FF] text-white font-bold uppercase tracking-widest text-sm shadow-xl mt-auto"
          ...
          <>
              ...
              <div className="flex-1 flex flex-col space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex flex-col items-center text-center space-y-6 pt-10">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-2xl font-bold text-black tracking-tight">Verify Your Account</h2>
                ...
                <Button 
                  className="w-full h-16 rounded-full bg-[#00A2FF] text-white font-bold uppercase tracking-widest text-sm shadow-xl shadow-blue-100 mt-auto"
            ...
            {step === 'capture' && capturedImage && (
              <div className="flex-1 flex flex-col space-y-8 animate-in zoom-in-95 duration-300">
                <h2 className="text-xl font-bold text-black text-center pt-4">Look Good?</h2>
                ...
                <div className="flex flex-col gap-4 mt-auto">
                  <Button 
                    className="w-full h-16 rounded-full bg-[#00A2FF] text-white font-bold uppercase tracking-widest text-sm shadow-xl"
                  ...
                  <Button 
                    variant="ghost" 
                    className="font-bold text-gray-400 uppercase text-[10px] tracking-widest"
                    onClick={() => fileInputRef.current?.click()}
                  >
                    Retake Photo
                  </Button>
